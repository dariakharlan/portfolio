  ...
  return (
    <section id="hero" className="min-h-screen snap-start flex flex-col items-center justify-center overflow-hidden px-margin-mobile md:px-margin-desktop">
      <div className="flex flex-col items-center text-center max-w-3xl mx-auto">
        ...
        <h1 className="animate-fade-up text-headline-xl md:text-[72px] md:leading-[1.1] md:tracking-tight text-on-surface mb-12 leading-[1.1] tracking-tight">
          Hi, I&apos;m <span className="personality-marker">Daria.</span>
        </h1>

        <p className="animate-fade-up-delay-1 text-body-md text-on-surface-variant mb-3">
          Creative and curious aspiring marketer transitioning from a career in software engineering.
        </p>
        <p className="animate-fade-up-delay-2 text-body-md text-on-surface-variant mb-16">I love coming up with ideas and bringing them to life, combining analytical thinking with creativity to develop engaging and effective campaigns.</p>
